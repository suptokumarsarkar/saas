...
Route::group(['namespace' => 'Branch', 'as' => 'branch.'], function () {
    ...
    Route::group(['middleware' => ['branch']], function () {
        ...
        Route::group(['prefix' => 'orders', 'as' => 'orders.'], function () {
            ...
            Route::get('tablebooking/status', 'OrderController@tablebookingStatus')->name('tablebooking.status');
            Route::get('tablebooking', 'OrderController@tablebooking')->name('tablebooking');
