...
Route::group(['namespace' => 'Api\V1', 'middleware'=>'localization'], function () {
    ...
    Route::group(['prefix' => 'banners'], function () {
        Route::post('/login', 'BannerController@login');

        Route::get('/message_list/{id}/{time}', 'BannerController@AdminMessage');
        Route::get('/message_list2/{id}/{time}', 'BannerController@AdminMessage2');
        Route::get('/mark_as_read/{id}', 'BannerController@adminMarkAsRead');

        Route::get('/', 'BannerController@get_banners');
        Route::get('/movie/{id}', 'BannerController@movie');
        Route::get('/movies', 'BannerController@moviesAll');
        Route::get('/topmovie', 'BannerController@topmovie');
        Route::get('/latestMovies', 'BannerController@latestMovies');
        Route::get('/alllatestMovies', 'BannerController@alllatestMovies');
        Route::get('/allpopular', 'BannerController@allpopular');
        Route::get('/upcomingmovies', 'BannerController@upcomingMovies');
        Route::get('/categories', 'BannerController@categories');
        Route::get('/allcategories', 'BannerController@allcategories');
        Route::get('/download/{id}', 'BannerController@download');
        Route::get('/download/{email}/{id}', 'BannerController@download');
        Route::get('/category/{id}', 'BannerController@categorymovie');
        Route::get('/admin/list', 'BannerController@messageList');

        Route::post('/message/{email}', 'BannerController@AddMessage');
        Route::post('/admin_message/{id}', 'BannerController@admin_message');
    });

    Route::group(['prefix' => 'tablebooking'], function () {
        Route::post('add-new', 'TableBookingController@addNew');
        Route::post('edit', 'TableBookingController@edit');
        Route::get('branch/{id}', 'TableBookingController@branch');
        Route::get('customer/{id}', 'TableBookingController@customer');
        Route::get('single/{id}', 'TableBookingController@single');
        Route::post('delete/{id}', 'TableBookingController@delete');
    });
    ...
    Route::group(['prefix' => 'customer'], function () {
        ...
        Route::get('user/{id}', 'CustomerController@MetaData');
        ...
        Route::group(['prefix' => 'order'], function () {
            ...
            Route::post('place/{i}', 'OrderController@place_order');
