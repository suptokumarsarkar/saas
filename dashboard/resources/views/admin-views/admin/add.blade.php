...
@section('title', \App\CentralLogics\translate('Add Admin'))
    ...
    <div class="content container-fluid">
            ...
            <div class="row align-items-center">
                <div class="col-sm mb-2 mb-sm-0">
                    <h1 class="page-header-title"><i class="tio-edit"></i>
                        {{\App\CentralLogics\translate('Add Admin')}}</h1>
                </div>
            </div>
        </div>
        <!-- End Page Header -->
        <div class="row gx-2 gx-lg-3">
            <div class="col-sm-12 col-lg-12 mb-3 mb-lg-2">
                <form action="{{route('admin.adminAddPost')}}" method="post"
                            ...
                            <div class="row">
                                <div class="col-12">
                                    <div class="form-group lang_form">
                                        ...
                                        <select name="status"
                                               class="form-control">
                                            <option value="1" selected>{{\App\CentralLogics\translate('active')}}</option>
