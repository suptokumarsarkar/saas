            ...
            <div class="col-sm-12 col-lg-12 mb-3 mb-lg-2">
                <form action="{{route('admin.banner.update',[$banner['id']])}}" method="post"
                    ...
                    <div class="row">
                        ...
                        <div class="col-4">
                            <div class="form-group">
                                <label class="input-label" for="exampleFormControlInput1">{{\App\CentralLogics\translate('location')}}</label>
                                <input type="text" name="location" value="{{$banner['location']}}" class="form-control"
                                       placeholder="{{\App\CentralLogics\translate('Top')}}" required>
                            </div>
                        </div>
                        <div class="col-4">
                            <div class="form-group">
