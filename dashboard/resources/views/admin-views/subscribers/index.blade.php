...
@section('title', \App\CentralLogics\translate('Subscriber List'))
        ...
        <div class="page-header">
            <div class="row align-items-center">
                <div class="col-sm mb-2 mb-sm-0">
                    <h1 class="page-header-title"><i class="tio-add-circle-outlined"></i> {{\App\CentralLogics\translate('Subscriber List')}}</h1>
                </div>
            </div>
        </div>
        <!-- End Page Header -->
                ...
                <div class="card">
                    <div class="card-header flex-between">
                        <div class="flex-start">
                            <h5 class="card-header-title">{{\App\CentralLogics\translate("All Subscribers")}}</h5>
                    ...
                    <div class="table-responsive datatable-custom">
                        <table class="table table-borderless table-thead-bordered table-nowrap table-align-middle card-table">
                            ...
                            <tr>
                                ...
                                <th style="width: 25%">{{\App\CentralLogics\translate('Type')}}</th>
                                        ...
                                        <div class="dropdown">
                                            ...
                                            <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                                                <a class="dropdown-item"
                                                   href="{{route('admin.subscriberEdit',[$customer['id']])}}">{{\App\CentralLogics\translate('edit')}}</a>
                                                ...
                                                <form action="{{route('admin.subscriberDeletePost',[$customer['id']])}}"
