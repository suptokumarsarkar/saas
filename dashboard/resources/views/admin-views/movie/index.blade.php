...
@section('title', \App\CentralLogics\translate('Add New Movie'))
    ...
    <div class="content container-fluid">
            ...
            <div class="row align-items-center">
                <div class="col-sm mb-2 mb-sm-0">
                    <h1 class="page-header-title"><i
                            class="tio-add-circle-outlined"></i> {{\App\CentralLogics\translate('Add New Movie')}}
                    </h1>
                </div>
            </div>
        </div>
        ...
        <div class="row gx-2 gx-lg-3">
            <div class="col-sm-12 col-lg-12 mb-3 mb-lg-2">
                <form action="{{route('admin.movie.addMoviePost')}}" method="post" enctype="multipart/form-data">
                    @csrf
                    <div class="row">
                        <div class="col-12 col-sm-6">
                            <div class="form-group">
                                ...
                                <input type="text" name="title" class="form-control" maxlength="255"
                                       placeholder="{{\App\CentralLogics\translate('title')}}" required>
                            </div>
                        </div>
                        <div class="col-12 col-sm-6">
                            <div class="form-group">
                                ...
                                <input type="date" name="publish_date" class="form-control" maxlength="255" required>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-12 col-sm-6 col-md-6">
                            <div class="form-group">
                                ...
                                <input type="text" step="any" name="download_link" class="form-control" >
                            </div>
                        </div>
                        <div class="col-12 col-sm-6 col-md-6">
                            <div class="form-group">
                                <label class="input-label" for="">{{\App\CentralLogics\translate('watch_link')}}</label>
                                <input type="text" step="any" name="watch_link" class="form-control">
                            </div>
                        </div>
                    </div>
                    <div class="row">
                        ...
                        <div class="col-12 col-sm-6 col-md-4">
                            <div class="form-group">
                                ...
                                <input type="text" step="any" name="tags" id="selectize_tags"
                                       required>
                            </div>
                        </div>
                        <div class="col-12 col-sm-6 col-md-4">
                            <div class="form-group">
                                ...
                                <input type="text" step="any"  class="form-control" name="popular"
                                       required>
                            </div>
                        </div>
                    </div>
