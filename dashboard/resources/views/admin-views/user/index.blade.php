...
@section('title', \App\CentralLogics\translate('User List'))
        ...
        <div class="page-header">
            <div class="row align-items-center">
                <div class="col-sm mb-2 mb-sm-0">
                    <h1 class="page-header-title"><i class="tio-add-circle-outlined"></i> {{\App\CentralLogics\translate('User List')}}</h1>
                </div>
            </div>
        </div>
        <!-- End Page Header -->
                ...
                <div class="card">
                    <div class="card-header flex-between">
                        <div class="flex-start">
                            <h5 class="card-header-title">{{\App\CentralLogics\translate("All Users")}}</h5>
                                        ...
                                        <div class="dropdown">
                                            ...
                                            <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                                                <a class="dropdown-item"
                                                   href="{{route('admin.userEdit',[$customer['id']])}}">{{\App\CentralLogics\translate('edit')}}</a>
                                                ...
                                                <form action="{{route('admin.userDeletePost',[$customer['id']])}}"
