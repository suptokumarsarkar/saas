                    ...
                    <!-- POS -->
                        ...
                        <li class="navbar-vertical-aside-has-menu {{Request::is('branch/orders*')?'active':''}}">
                            ...
                            <ul class="js-navbar-vertical-aside-submenu nav nav-sub"
                                ...
                                <li class="nav-item {{Request::is('branch/orders/tablebooking')?'active':''}}">
                                    <a class="nav-link " href="{{route('branch.orders.tablebooking')}}" title="">
                                        <span class="tio-circle nav-indicator-icon"></span>
                                        <span class="text-truncate">
                                            {{\App\CentralLogics\translate('Table Booking')}}
                                                <span class="badge badge-soft-info badge-pill ml-1">
                                                {{\App\Model\Tablebooking::where(['checked' => 0,'branchId' => auth('branch')->id()])->count()}}
                                            </span>
                                        </span>
                                    </a>
                                </li>
