...
@section('title', 'Customer Stories | LightNit Products')
...
@push('headerScript')
    ...
    <link rel="stylesheet"
          href="{{asset('public/css/works_responsive.css' . App\Logic\Helpers::production("version"))}}">
    <link rel="stylesheet" href="{{asset('public/css/blog.style.css' . App\Logic\Helpers::production("version"))}}">
    <link rel="stylesheet"
          href="{{asset('public/css/responsive_style.css' . App\Logic\Helpers::production("version"))}}">
    <link rel="stylesheet" href="{{asset('public/css/feature_style.css' . App\Logic\Helpers::production("version"))}}">
    <link rel="stylesheet"
          href="{{asset('public/css/blog.responsive.css' . App\Logic\Helpers::production("version"))}}">
...
@section("content")
    ...
    {{--Include Post 1--}}
    @includeIf('Website.Components.Blogs.BlogPosts', ['showall' => false, 'posts'=>$posts])
    ...
    @includeIf('Website.Components.Blogs.BusinessPlan')

    {{--Include SmallTips--}}
    @includeIf('Website.Components.Blogs.SmallTips')

    {{--Include AutomateBanner--}}
    @includeIf('Website.Components.Blogs.AutomateBanner')

    {{--Include Recommendation--}}
    @includeIf('Website.Components.Blogs.Recommendation')

    {{--Include SubscribeBorderLess--}}
    @includeIf('Website.Components.Blogs.SubscribeBorderLess')

    {{--Include SignupBanner--}}
    @includeIf('Website.Components.Blogs.SignupBanner')
