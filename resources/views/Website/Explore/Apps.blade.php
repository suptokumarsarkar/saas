...
@section('title', 'All Apps Finder | LightNit Explore')
...
@push('headerScript')
    ...
    <link rel="stylesheet" href="{{asset('public/css/apps_style.css' . App\Logic\Helpers::production("version"))}}">
    <link rel="stylesheet" href="{{asset('public/css/apps_responsive.css' . App\Logic\Helpers::production("version"))}}">
@endpush
@section("content")
    ...
    {{--Include Role--}}
    @includeIf('Website.Components.Explore.Apps')
