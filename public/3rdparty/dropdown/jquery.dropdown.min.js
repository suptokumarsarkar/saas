(function (e) {
    ...
    function t() {
        var e = this.isLabelMode, o = this.config.searchable,
    ...
    function i() {
        var o = this, n = o.config, t = o.$el, i = t.find(".dropdown-minItem-alert"), l = n.minCountErrorMessage;
        clearTimeout(o.itemCountAlertTimer), 0 === i.length && (l || (l = "" + n.minCount + ""), i = e('<div class="dropdown-minItem-alert">' + l + "</div>")), t.append(i), o.itemCountAlertTimer = setTimeout(function () {
            t.find(".dropdown-minItem-alert").remove()
        }, f)
    }

    function l() {
        var o = this, n = o.config, t = o.$el, i = t.find(".dropdown-maxItem-alert"), l = n.limitCountErrorMessage;
        clearTimeout(o.itemLimitAlertTimer), 0 === i.length && (l || (l = "" + n.limitCount + "个"), i = e('<div class="dropdown-maxItem-alert">' + l + "</div>")), t.append(i), o.itemLimitAlertTimer = setTimeout(function () {
    ...
    function a(o) {
        ...
        return n = n.replace(/<select[^>]*>/gi, "").replace("</select>", ""), n = n.replace(/<\/optgroup>/gi, ""), n = n.replace(/<optgroup[^>]*>/gi, function (e) {
            var o = /label="(.[^"]*)"(\s|>)/.exec(e), n = /data\-group\-id="(.[^"]*)"(\s|>)/.exec(e);
            return '<li class="dropdown-group" data-group-id="' + (n ? n[1] : "") + '">' + (o ? o[1] : "") + "</li>"
        }), n = n.replace(/<option(.*?)<\/option>/gi, function (o) {
            var n = e(o).val(), t = />(.*)<\//.exec(o), i = o.indexOf("selected") > -1, l = o.indexOf("disabled") > -1,
                a = "";
    ...
    function d(o) {
        var n = this, t = {}, i = "", l = [], a = 0, d = n.config.extendProps;
        return !(!o || !o.length) && (e.each(o, function (o, n) {
            var i = n.groupId, s = n.disabled ? " disabled" : "", r = n.selected && !s ? " selected" : "", c = "";
    ...
    var c = function () {
        ...
        data: [],
        searchable: !0,
        searchNoData: '<li style="color:#ddd">/li>',
        init: o,
        choice: o,
        extendProps: []
    }, u = {up: 38, down: 40, enter: 13}, h = {
        ...
        show: function (o) {
            ...
            var n = this, t = n.config, i = n.$el, l = e(o.target), s = l.val(), r = n.config.data, c = [];
        ...
        }, 300), control: function (o) {
            var n, t, i, l = o.keyCode, a = u, d = 0;
            ...
            var t, a = this, d = a.config, s = a.$select, r = e(o.target), c = r.attr("data-value"),
                p = r.hasClass("dropdown-chose"), u = [];
            if (r.hasClass("dropdown-display")) return !1;
            if (p) r.removeClass("dropdown-chose"), a.selectAmount--; else {
            ...
            var n = this, t = n.config, i = n.$el, l = n.$select, a = e(o.target), d = a.attr("data-value"),
            ...
            var n = this, t = n.config, i = e(o.target), l = i.data("id");
    ...
    r.prototype = {
        init: function () {
            ...
            var i, l = this, d = l.$el, s = l.$select, r = a(s.prop("outerHTML"));
            ...
            var o = this, n = o.$el, t = c ? h.click : h.focus;
            ...
            var e = this, o = e.$el, n = c ? h.click : h.focus;
            ...
            var n = this, t = n.config, i = (n.$el, o || !1);
            ...
            var t = "[object Array]" === Object.prototype.toString.call(o) ? o : [o], i = this, l = void 0 === n || !!n;
            e.each(t, function (e, o) {
                var t = i.$el.find('[data-value="' + o + '"]'), a = t.hasClass("dropdown-chose");
